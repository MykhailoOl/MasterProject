...
public class AnthropicLlmClient implements LlmClient {
    ...
    public AnthropicLlmClient(RestClient.Builder restClientBuilder, ObjectMapper objectMapper) {
    ...
    public List<String> displayParams() {
        return List.of(
                ...
                "health check=POST /v1/messages max_tokens=" + settings.healthCheckMaxTokens());
    }
}
